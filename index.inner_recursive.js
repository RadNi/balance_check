...
import innerCircuit from "./recursive_circuit/target/balance_check_inner.json";
import { Noir } from '@noir-lang/noir_js';

import recursiveCircuit from "./recursive_circuit/target/balance_check_recursive.json" assert { type: "json" };

// import { CompiledCircuit, Noir } from "@noir-lang/noir_js";

let root_root = ["148", "35", "98", "239", "195", "24", "71", "219", "91", "186", "52", "161", "79", "10", "122", "82", "6", "121", "232", "74", "132", "155", "156", "226", "255", "44", "236", "132", "237", "77", "189", "6"]
let inner_trie_key = ["250", "10", "34", "196", "236", "136", "78", "219", "205", "24", "80", "185", "220", "203", "84", "133", "80", "219", "179", "28", "149", "211", "138", "28", "40", "9", "3", "92", "253", "76", "62", "160"]
let inner_trie_key_new_index = "3"
let inner_node_length = "3"
let inner_new_root = ["89", "96", "76", "21", "102", "145", "148", "92", "221", "60", "39", "17", "14", "0", "206", "183", "88", "194", "87", "41", "226", "28", "165", "89", "196", "109", "138", "213", "115", "67", "37", "191"]
...
let recursive_node_length = "2"
let recursive_trie_key_new_index = "5"
let recursive_new_root = ["99", "193", "21", "67", "110", "89", "151", "139", "77", "114", "232", "226", "225", "255", "14", "120", "173", "67", "192", "253", "27", "236", "21", "203", "180", "1", "59", "157", "40", "72", "18", "7"]
...
const show = (id, content) => {
   ...
   document.getElementById("submit").addEventListener("click", async () => {
	// try {
        ...
        const innerCircuitNoir = new Noir(innerCircuit);
        ...
        const { witness } = await innerCircuitNoir.execute({
            nodes: inner_nodes, 
            node_length: inner_node_length, 
            root: root_root, 
            trie_key: inner_trie_key, 
            trie_key_new_index: inner_trie_key_new_index, 
            new_root: inner_new_root
        });
		show("logs", "Generating inner circuit proof... ⏳");
        const innerProof = await innerBackend.generateProofForRecursiveAggregation(witness);
		show("results", innerProof.proof);
        ...
        const recursiveCircuitNoir = new Noir(recursiveCircuit);
    ...
    // public_inputs: pub [Field; 4]
        ...
        const recursiveInputs = { 
            ...
            node_length: recursive_node_length,
            new_root: recursive_new_root,
            trie_key_new_index: recursive_trie_key_new_index
        };
        console.log(recursiveInputs.public_inputs)

        const { witness: recursiveWitness } = await recursiveCircuitNoir.execute(recursiveInputs);
        
        show("logs", "Generating recursive circuit proof... ⏳");
        const { proof: recursiveProof, publicInputs: recursivePublicInputs } = await recursiveBackend.generateProof(recursiveWitness);

        // Verify recursive proof
        show("logs", "Verifying recursive circuit proof... ⏳");
        const verified = await recursiveBackend.verifyProof({ proof: recursiveProof, publicInputs: recursivePublicInputs });
        show("logs", "Recursive proof verified: " + verified);

		// const { witness } = await noir.execute({ nodes, account, node_length, root, balance_target, balance_target_length });
